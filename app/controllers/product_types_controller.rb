class ProductTypesController < ApplicationController
  ...
  private
    ...
    def product_type_params
      params.require(:product_type).permit(:name, :description, :product_id, :land_area_square_meter, :land_area_square_feet, :extra_land_square_meter, :extra_land_square_feet, :extra_land_price, :hide_detail_blocked_unit, :hide_price_of_sold_unit, :notify_agent_on_booking_unit, :hide_price_of_reserved_unit)
    end
