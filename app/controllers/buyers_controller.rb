class BuyersController < ApplicationController
  ...
  private
    ...
    def buyer_params
      params.require(:buyer).permit(:full_name, :ic_number, :address, :mobile_contact_number, :home_contact_number, :office_contact_number, :email, :status_id, :gender, :age, :region, :race, :sources)
    end
end
