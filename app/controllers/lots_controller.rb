class LotsController < ApplicationController
  ...
  private
    ...
    def lot_params
      params.require(:lot).permit(:name, :description, :product_id, :land_area_square_meter, :land_area_square_feet, :extra_land_square_meter, :extra_land_square_feet, :premium, :extra_land_price, :selling_price, :is_special_unit, :car_park)
    end
